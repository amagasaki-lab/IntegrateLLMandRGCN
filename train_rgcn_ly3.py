...
def trainer(device, variant_model_name, aggregation_mode, save_name, dataset_name, hyper_params):
...
if __name__ == "__main__":
    ...
    for i in range(num_of_model):
        ...
        save_name = variant_model_name + "_" + aggregation_mode + "_model_trained_" + dataset_name + "-kai-" + save_date
        trainer(device, variant_model_name, aggregation_mode, save_name, dataset_name, hyper_params)
