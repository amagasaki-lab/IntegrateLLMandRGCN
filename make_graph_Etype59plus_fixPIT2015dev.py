...
if __name__ == "__main__":
    ...
    dataset_validation = graph_data_maker.trans_dataset_kai_type2(dataset["validation"], header, f"{dataset_name}-Etype59plus-kai5-{L_flag}validation{guidelined_tag}")
